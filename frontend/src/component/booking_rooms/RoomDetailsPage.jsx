...
const RoomDetailsPage = () => {
  ...
  const acceptBooking = async () => {
    ...
    // Add to cart
    const result = addToCart(roomDetails, formattedCheckInDate, formattedCheckOutDate, numAdults, numChildren);
    ...
    <div className="room-details-booking">
      {showMessage && (
        <p className="booking-success-message">
          {confirmationCode ? `Booking successful! Confirmation code: ${confirmationCode}. An SMS and email of your booking details have been sent to you.` : 'Room added to cart successfully! Redirecting...'}
        </p>
      )}
      {errorMessage && (
      ...
      <div className="booking-info">
        <button className="book-now-button" onClick={() => setShowDatePicker(true)}>Select Dates & Add to Cart</button>
        ...
        {totalPrice > 0 && (
          <div className="total-price">
            ...
            <button onClick={handleAddToCart} className="accept-booking" style={{ marginRight: '10px' }}>Add to Cart</button>
            <button onClick={acceptBooking} className="accept-booking">Book Now (Direct)</button>
          </div>
        )}
      </div>
    </div>
