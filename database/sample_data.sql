...
INSERT INTO users (email, name, phone_number, password, role) VALUES
...
INSERT INTO bookings (check_in_date, check_out_date, num_of_adults, num_of_children, total_num_of_guest, booking_confirmation_code, user_id, room_id) VALUES
...
INSERT INTO bookings (check_in_date, check_out_date, num_of_adults, num_of_children, total_num_of_guest, booking_confirmation_code, user_id, room_id) VALUES
('2026-01-15', '2026-01-20', 2
, 0, 2, 'CONF-2026-005-MNO', 2, 13);
...
-- Display all rooms grouped by type
SELECT room_type, COUNT(*) AS room_count, MIN(room_price) AS min_price, MAX(room_price) AS max_price
FROM rooms
GROUP BY room_type
ORDER BY min_price DESC;

-- Display all bookings with user and room details
SELECT 
    b.id,
    ...
    ROUND(r.room_price * DATEDIFF(b.check_out_date, b.check_in_date), 2) AS total_cost
FROM bookings b
